...
* `settings.py`: A file with a number of supporting fixed variables used throughout the simulation, like the number of tasks of each agent, the cooldown kill for the impostor and the tasks' cooldown.
